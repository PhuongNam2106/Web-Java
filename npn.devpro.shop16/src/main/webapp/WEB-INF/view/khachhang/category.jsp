...
<jsp:include page="/WEB-INF/view/common/variable.jsp"></jsp:include>;
    ...
    <div style=" max-width: 1350px; margin-top: 154px;" class="container">
        <div class="row col-12" style="padding-left: 0px;">
             <form  action="${base }/category/${categories.id}"  method="get" class="col-3 justify-content-start" style="padding-left: 0px;" >
                ...
                <c:forEach items="${categories}" var="category" varStatus="loop">
                    <a style="text-transform: uppercase;" href="${base}/category/${category.id}" class="list-group-item list-group-item-action name-category-item">${category.name }</a>
                  </c:forEach>
                  </div>
            </form> 
            ...
            <div class="col-9 content">
                ...
                <div class="row list-product" action="${base}/category/${category.id}" method="get">
                  
	                <c:forEach items="${productsData.data}" var="product" varStatus="loop">
	                	<c:if test="${product.getCategories().getId() == categories.id}">	
		                    <div class="col-lg-3 col-md-4 col-sm-6  ">
		                        <div style="margin-bottom: 10px !important;" class="card card-custom">
		                            ...
		                            <span class="card-text new-price">${product.priceSale }</span>
		                            </div>
		                        </div>                       
		                    </div>
		                 </c:if>
