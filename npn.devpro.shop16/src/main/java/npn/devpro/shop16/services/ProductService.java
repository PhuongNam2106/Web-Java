...
public class ProductService extends BaseService<Products> {
	...
	public String UP_LOAD_FOLDER_ROOT = "D:/Java WEB/upload/";
	...
	@Transactional
	public Products add(Products p, MultipartFile avatar, MultipartFile[] productImage)
	...
	//cập nhật 
	@Transactional
	public Products update(Products p, MultipartFile avatar, MultipartFile[] productImage)
			throws IllegalStateException, IOException {
